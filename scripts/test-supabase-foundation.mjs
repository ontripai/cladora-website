...
check(authEmailPolicy.includes("invite: (lang) => [\`/\${lang}/invitation-continuation\`, \`/\${lang}/cases\`]") && authEmailPolicy.includes("recovery: (lang) => [\`/\${lang}/reset-password\`]"), 'verified Invite permits tokenless continuation or the customer case inbox while Recovery enters password reset');
