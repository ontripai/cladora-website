...
do $$ begin
  ...
  insert into platform.customer_workspaces(id,tenant_id,workspace_type,lifecycle_status,commercial_owner,environment) values('45800000-0000-0000-0000-000000000001','45100000-0000-0000-0000-000000000001','ASSOCIATION','ACTIVE','Commercial 045','PILOT');
end $$;
