...
begin
  ...
  insert into identity.context_grants (id, membership_id, tenant_id, scope_type, unit_id, starts_at, ends_at) values
    ...
    ('23400000-0000-0000-0000-000000000004', '23300000-0000-0000-0000-000000000001', '23100000-0000-0000-0000-000000000001', 'tenant', null, statement_timestamp() - interval '1 day', null),
