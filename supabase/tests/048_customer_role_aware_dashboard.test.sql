...
begin
  ...
  insert into platform.tenants (id, legal_name, registration_number, status) values
    ...
    ('21100000-0000-0000-0000-000000000050', 'Tenant Pairing 50', 'RO-ENG-048-50', 'active'),
    ('21100000-0000-0000-0000-000000000051', 'Tenant Pairing 51', 'RO-ENG-048-51', 'active'),
    ('21100000-0000-0000-0000-000000000060', 'Tenant Pairing 60', 'RO-ENG-048-60', 'active'),
    ('21100000-0000-0000-0000-000000000061', 'Tenant Pairing 61', 'RO-ENG-048-61', 'active');
  ...
  insert into platform.customer_workspaces (id, tenant_id, workspace_type, lifecycle_status, commercial_owner, environment, version) values
    ...
    ('21800000-0000-0000-0000-000000000050', '21100000-0000-0000-0000-000000000050', 'ASSOCIATION', 'ACTIVE', 'Admin 50', 'PILOT', 1),
    ('21800000-0000-0000-0000-000000000051', '21100000-0000-0000-0000-000000000051', 'ASSOCIATION', 'ACTIVE', 'Admin 51', 'PILOT', 1),
    ('21800000-0000-0000-0000-000000000060', '21100000-0000-0000-0000-000000000060', 'ASSOCIATION', 'ACTIVE', 'Admin 60', 'PILOT', 1),
    ('21800000-0000-0000-0000-000000000061', '21100000-0000-0000-0000-000000000061', 'ASSOCIATION', 'ACTIVE', 'Admin 61', 'PILOT', 1);
  ...
  insert into platform.workspace_entitlements (customer_workspace_id, entitlement_key, value_type, boolean_value, valid_from, valid_until, override_value_json, override_expires_at) values
    ...
    -- Pairing 50: ONLY module.billing
    ('21800000-0000-0000-0000-000000000050', 'module.billing', 'boolean', true, statement_timestamp() - interval '1 day', null, null, null),
    -- Pairing 51: ONLY module.billing
    ('21800000-0000-0000-0000-000000000051', 'module.billing', 'boolean', true, statement_timestamp() - interval '1 day', null, null, null),
    -- Pairing 60: ONLY module.accounting
    ('21800000-0000-0000-0000-000000000060', 'module.accounting', 'boolean', true, statement_timestamp() - interval '1 day', null, null, null),
    -- Pairing 61: ONLY module.accounting
    ('21800000-0000-0000-0000-000000000061', 'module.accounting', 'boolean', true, statement_timestamp() - interval '1 day', null, null, null),
  ...
  insert into identity.roles (id, tenant_id, code, name) values
    ...
    ('21200000-0000-0000-0000-000000000050', '21100000-0000-0000-0000-000000000050', 'association_admin', 'Admin Pairing 50'),
    ('21200000-0000-0000-0000-000000000051', '21100000-0000-0000-0000-000000000051', 'association_admin', 'Admin Pairing 51'),
    ('21200000-0000-0000-0000-000000000060', '21100000-0000-0000-0000-000000000060', 'association_admin', 'Admin Pairing 60'),
    ('21200000-0000-0000-0000-000000000061', '21100000-0000-0000-0000-000000000061', 'association_admin', 'Admin Pairing 61');
  ...
  insert into identity.memberships (id, tenant_id, user_id, role_id, status, starts_at, ends_at) values
    ...
    ('21300000-0000-0000-0000-000000000050', '21100000-0000-0000-0000-000000000050', '21000000-0000-0000-0000-000000000050', '21200000-0000-0000-0000-000000000050', 'active', statement_timestamp() - interval '1 day', null),
    ('21300000-0000-0000-0000-000000000051', '21100000-0000-0000-0000-000000000051', '21000000-0000-0000-0000-000000000051', '21200000-0000-0000-0000-000000000051', 'active', statement_timestamp() - interval '1 day', null),
    ('21300000-0000-0000-0000-000000000060', '21100000-0000-0000-0000-000000000060', '21000000-0000-0000-0000-000000000060', '21200000-0000-0000-0000-000000000060', 'active', statement_timestamp() - interval '1 day', null),
    ('21300000-0000-0000-0000-000000000061', '21100000-0000-0000-0000-000000000061', '21000000-0000-0000-0000-000000000061', '21200000-0000-0000-0000-000000000061', 'active', statement_timestamp() - interval '1 day', null);
  ...
  insert into portfolio.properties (id, tenant_id, type, name, status) values
    ...
    ('21500000-0000-0000-0000-000000000050', '21100000-0000-0000-0000-000000000050', 'condominium', 'Property 50', 'active'),
    ('21500000-0000-0000-0000-000000000051', '21100000-0000-0000-0000-000000000051', 'condominium', 'Property 51', 'active'),
    ('21500000-0000-0000-0000-000000000060', '21100000-0000-0000-0000-000000000060', 'condominium', 'Property 60', 'active'),
    ('21500000-0000-0000-0000-000000000061', '21100000-0000-0000-0000-000000000061', 'condominium', 'Property 61', 'active');
  ...
  insert into portfolio.buildings (id, tenant_id, property_id, code, name, status) values
    ...
    ('21600000-0000-0000-0000-000000000050', '21100000-0000-0000-0000-000000000050', '21500000-0000-0000-0000-000000000050', 'B50', 'Building 50', 'active'),
    ('21600000-0000-0000-0000-000000000051', '21100000-0000-0000-0000-000000000051', '21500000-0000-0000-0000-000000000051', 'B51', 'Building 51', 'active'),
    ('21600000-0000-0000-0000-000000000060', '21100000-0000-0000-0000-000000000060', '21500000-0000-0000-0000-000000000060', 'B60', 'Building 60', 'active'),
    ('21600000-0000-0000-0000-000000000061', '21100000-0000-0000-0000-000000000061', '21500000-0000-0000-0000-000000000061', 'B61', 'Building 61', 'active');
  ...
  insert into portfolio.units (id, tenant_id, building_id, code, status) values
    ...
    ('21700000-0000-0000-0000-000000000050', '21100000-0000-0000-0000-000000000050', '21600000-0000-0000-0000-000000000050', 'U50', 'active'),
    ('21700000-0000-0000-0000-000000000051', '21100000-0000-0000-0000-000000000051', '21600000-0000-0000-0000-000000000051', 'U51', 'active'),
    ('21700000-0000-0000-0000-000000000060', '21100000-0000-0000-0000-000000000060', '21600000-0000-0000-0000-000000000060', 'U60', 'active'),
    ('21700000-0000-0000-0000-000000000061', '21100000-0000-0000-0000-000000000061', '21600000-0000-0000-0000-000000000061', 'U61', 'active');
  ...
  insert into portfolio.parties (id, tenant_id, type, legal_name) values
    ...
    ('21900000-0000-0000-0000-000000000050', '21100000-0000-0000-0000-000000000050', 'person', 'Party 50'),
    ('21900000-0000-0000-0000-000000000051', '21100000-0000-0000-0000-000000000051', 'person', 'Party 51'),
    ('21900000-0000-0000-0000-000000000060', '21100000-0000-0000-0000-000000000060', 'person', 'Party 60'),
    ('21900000-0000-0000-0000-000000000061', '21100000-0000-0000-0000-000000000061', 'person', 'Party 61');
  ...
  insert into billing.invoices (id, tenant_id, property_id, unit_id, liable_party_id, period_start, period_end, issued_on, due_on, currency, subtotal, tax_total, status) values
    ...
    ('21c00000-0000-0000-0000-000000000050', '21100000-0000-0000-0000-000000000050', '21500000-0000-0000-0000-000000000050', '21700000-0000-0000-0000-000000000050', '21900000-0000-0000-0000-000000000050', current_date - 30, current_date, current_date - 1, current_date + 5, 'RON', 100, 0, 'issued'),
    ('21c00000-0000-0000-0000-000000000051', '21100000-0000-0000-0000-000000000051', '21500000-0000-0000-0000-000000000051', '21700000-0000-0000-0000-000000000051', '21900000-0000-0000-0000-000000000051', current_date - 30, current_date, current_date - 1, current_date + 5, 'RON', 100, 0, 'issued'),
    ('21c00000-0000-0000-0000-000000000060', '21100000-0000-0000-0000-000000000060', '21500000-0000-0000-0000-000000000060', '21700000-0000-0000-0000-000000000060', '21900000-0000-0000-0000-000000000060', current_date - 30, current_date, current_date - 1, current_date + 5, 'RON', 100, 0, 'issued'),
    ('21c00000-0000-0000-0000-000000000061', '21100000-0000-0000-0000-000000000061', '21500000-0000-0000-0000-000000000061', '21700000-0000-0000-0000-000000000061', '21900000-0000-0000-0000-000000000061', current_date - 30, current_date, current_date - 1, current_date + 5, 'RON', 100, 0, 'issued');
  ...
  insert into billing.receivables (tenant_id, invoice_id, original_amount, paid_amount) values
    ...
    ('21100000-0000-0000-0000-000000000050', '21c00000-0000-0000-0000-000000000050', 100, 20), -- 80 outstanding in 50
    ('21100000-0000-0000-0000-000000000051', '21c00000-0000-0000-0000-000000000051', 100, 20), -- 80 outstanding in 51
    ('21100000-0000-0000-0000-000000000060', '21c00000-0000-0000-0000-000000000060', 100, 10), -- 90 outstanding in 60
    ('21100000-0000-0000-0000-000000000061', '21c00000-0000-0000-0000-000000000061', 100, 10); -- 90 outstanding in 61

  -- 13. Work Orders
  insert into maintenance.work_orders (id, tenant_id, property_id, building_id, unit_id, title, priority, status) values
    ('21d00000-0000-0000-0000-000000000001', '21100000-0000-0000-0000-000000000001', '21500000-0000-0000-0000-000000000001', '21600000-0000-0000-0000-000000000001', '21700000-0000-0000-0000-000000000001', 'Fix pipe in UA1', 'high', 'in_progress'),
    ('21d00000-0000-0000-0000-000000000002', '21100000-0000-0000-0000-000000000001', '21500000-0000-0000-0000-000000000001', '21600000-0000-0000-0000-000000000001', '21700000-0000-0000-0000-000000000002', 'Fix door in UA2', 'normal', 'assigned'),
    ('21d00000-0000-0000-0000-000000000003', '21100000-0000-0000-0000-000000000002', '21500000-0000-0000-0000-000000000002', '21600000-0000-0000-0000-000000000002', '21700000-0000-0000-0000-000000000003', 'Beta work order', 'low', 'assigned');

  -- 14. Notifications
  insert into communications.notifications (id, tenant_id, membership_id, type, title) values
    ('21e00000-0000-0000-0000-000000000001', '21100000-0000-0000-0000-000000000001', '21300000-0000-0000-0000-000000000001', 'system', 'Admin Notice'),
    ('21e00000-0000-0000-0000-000000000002', '21100000-0000-0000-0000-000000000001', '21300000-0000-0000-0000-000000000005', 'system', 'Owner Notice');
  ...
  insert into identity.context_grants (id, membership_id, tenant_id, scope_type, property_id, building_id, unit_id, starts_at, ends_at) values
    ...
    ('21400000-0000-0000-0000-000000000058', '21300000-0000-0000-0000-000000000005', '21100000-0000-0000-0000-000000000001', 'property', '21500000-0000-0000-0000-000000000001', null, null, statement_timestamp() - interval '1 day', null),
    -- owner 1 mismatched: unit scope with UA2 (which belongs to Owner 2)
    ('21400000-0000-0000-0000-000000000059', '21300000-0000-0000-0000-000000000005', '21100000-0000-0000-0000-000000000001', 'unit', '21500000-0000-0000-0000-000000000001', '21600000-0000-0000-0000-000000000001', '21700000-0000-0000-0000-000000000002', statement_timestamp() - interval '1 day', null),
    ...
    ('21400000-0000-0000-0000-000000000050', '21300000-0000-0000-0000-000000000050', '21100000-0000-0000-0000-000000000050', 'tenant', null, null, null, statement_timestamp() - interval '1 day', null),
    -- Epsilon Admin (Accounting perm) Context
    ('21400000-0000-0000-0000-000000000051', '21300000-0000-0000-0000-000000000051', '21100000-0000-0000-0000-000000000051', 'tenant', null, null, null, statement_timestamp() - interval '1 day', null),
    -- Zeta Admin (Billing perm) Context
    ('21400000-0000-0000-0000-000000000060', '21300000-0000-0000-0000-000000000060', '21100000-0000-0000-0000-000000000060', 'tenant', null, null, null, statement_timestamp() - interval '1 day', null),
    -- Zeta Admin (Accounting perm) Context
    ('21400000-0000-0000-0000-000000000061', '21300000-0000-0000-0000-000000000061', '21100000-0000-0000-0000-000000000061', 'tenant', null, null, null, statement_timestamp() - interval '1 day', null);
end $$;
...
-- Owner rejections
select throws_like(
  $$select platform.get_customer_dashboard('21400000-0000-0000-0000-000000000058')$$,
  '%unit_context_required%',
  'owner with property scope is denied'
);
select throws_like(
  $$select platform.get_customer_dashboard('21400000-0000-0000-0000-000000000059')$$,
  '%ownership_required%',
