...
begin
  ...
  insert into identity.memberships (id, tenant_id, user_id, role_id, status, starts_at, ends_at) values
    ...
    ('21300000-0000-0000-0000-000000000006', '21100000-0000-0000-0000-000000000006', '21200000-0000-0000-0000-000000000005', 'active', statement_timestamp() - interval '1 day', null),
