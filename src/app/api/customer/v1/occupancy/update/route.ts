...
import { updateOccupancyRequestSchema } from "@/lib/customer/occupancy-schema";
...
async function handleUpdate(request: NextRequest) {
  ...
  const parsed = updateOccupancyRequestSchema.safeParse(rawBody);
  if (!parsed.success) {
