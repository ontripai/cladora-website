...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (metadataUpdateError) {
      console.error('[METADATA_UPDATE_ERROR] Failed to record notification status in lead record:', {
        referenceId: savedReferenceId,
    ...
    console.error('[METADATA_UPDATE_EXCEPTION] Exception while recording notification status:', {
      referenceId: savedReferenceId,
