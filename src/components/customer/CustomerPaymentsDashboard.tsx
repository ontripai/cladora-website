...
const copy = {
  ...
  en: {
    ...
    confirm: 'Confirm',
    reason: 'Reason',
    reverseWarning: 'Payment reversal will post an auditable compensating journal in the supplemental ledger (Dr. AR / Cr. Bank).',
    allocating: 'Allocating…',
    recording: 'Recording…',
    reversing: 'Reversing…',
    finalizing: 'Finalizing…',
    reconcileSuccess: 'Reconciliation finalized successfully!',
    ledgerBalanced: 'Balanced Supplemental Journal (Debit = Credit)',
